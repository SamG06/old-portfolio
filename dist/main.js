...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"videoGenerator\": () => (/* binding */ videoGenerator)\n/* harmony export */ });\nvar videoGenerator = function videoGenerator(videoId) {\n  return (\n    /*html*/\n    \"<div class=\\\"video-wrapper\\\">\\n    <iframe\\n      src=\\\"https://iframe.videodelivery.net/\".concat(videoId, \"\\\"\\n      style=\\\"border: none;width: 100%;max-width:1080px\\\"\\n      allow=\\\"accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;\\\"\\n      allowfullscreen=\\\"true\\\"\\n      id=\\\"stream-player\\\"\\n    ></iframe>\\n  \\n    <script src=\\\"https://embed.videodelivery.net/embed/sdk.latest.js\\\"></script>\\n  \\n    <!-- Your JavaScript code below-->\\n    <script>\\n      const player = Stream(document.getElementById('stream-player'))\\n      player.addEventListener('play', () => {\\n        console.log('playing!')\\n      })\\n      player.play().catch(() => {\\n        console.log('playback failed, muting to try again')\\n        player.muted = true\\n        player.play()\\n      })\\n    </script>\\n  </div>\")\n  );\n};\n\n//# sourceURL=webpack://vanilla-portfolio/./src/js/projects/pieces.js?");
